...
const server = new _apolloServer.ApolloServer({
  ...
  context: ({
    ...
    const parksLoader = new _dataloader.default(npsAPI.parksLoaderFunction(api_key));
    const campgroundsLoader = new _dataloader.default(npsAPI.campgroundsLoaderFunction(api_key));
    return {
      api_key,
      parksLoader,
      campgroundsLoader
